...
\begin{longtable}{|l|p{0.4\textwidth}|p{0.4\textwidth}|l|}
  ...
  \hline
  15 & Implementierung der Mapping-Funktion & Umsetzung der Mapping-Logik zur Zuordnung von externen Rollen auf interne LDAP-Gruppen. Implementierung wird laufend dokumentiert.&  \\
  \hline
  16 & Testen der Mapping-Funktion & Die Mapping-Funktion wurde ausgieblich getestet und die Funtionen wurden mit passenden Tests ausgestattet. Umsetzung wird laufend dokumentiert&  \\
  \hline
