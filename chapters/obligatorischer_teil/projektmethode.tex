...
In dieser Phase wird das entwickelte System dem Kunden vorgestellt und zur Abnahme bereitgestellt. Bei internen Entwicklungen wird die Funktion dem Auftraggeber, meist Business Engineer oder Product Owner, vorgestellt. Nach der Vorstellung wird die Funktion in die nächste Umgebung deployed und von den entsprechenden Personen abgenommen.
