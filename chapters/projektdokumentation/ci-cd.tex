...
\begin{enumerate}
    ...
    \item \textbf{Verfügbarkeit prüfen:} Es wird mit einem einfachen \texttt{curl}-Befehl regelmäßig geprüft, ob die Applikation über ihren Heartbeat-Endpunkt erreichbar ist.
